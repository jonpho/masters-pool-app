...
desc 'Creates the CSV file of golfers for seeding db.'
task :create_golfer_csv do
  pros = CSV.parse(File.read("lib/tasks/Masters2023Pros.csv"), headers: true)
  amateurs = CSV.parse(File.read("lib/tasks/Masters2023Amateurs.csv"), headers: true)
  rankings = CSV.parse(File.read("lib/tasks/golf_world_rankings_list.csv"), headers: true)
